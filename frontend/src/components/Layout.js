...
import { LayoutDashboard, ImagePlus, FileText, Lightbulb, LogOut, Youtube } from "lucide-react";
...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen flex bg-[#09090B] text-zinc-100 grain">
      <aside className="w-64 border-r border-zinc-800 fixed left-0 top-0 h-screen flex flex-col p-5 z-10">
      ...
      <main className="ml-64 flex-1 min-h-screen relative z-[2]">
        {children}
      </main>
    </div>
  );
